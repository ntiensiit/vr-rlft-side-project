...
- GitHub CI pytest step on Linux: headless Open3D/Mesa/EGL setup, xvfb, hatch package path; Open3D import before NumPy in data-prep scripts to avoid subprocess segfault (exit 139).
