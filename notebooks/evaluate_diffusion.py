...
ctx = load_notebook_context(
    root,
    "config",
    overrides=["evaluation=diffusion", "training=diffusion"],
    config_labels={"diffusion": "evaluation/diffusion"},
)
...
# %%
run_generative_eval_notebook(ctx, method="diffusion", dataset_paths=paths)
